...
BEGIN
    ...
    SET @batch_start_time = GETDATE();
        ...
        INSERT INTO silver.erp_cust_az12(cid, bdate, gndr)
        SELECT
            CASE
           ...
           CASE
               ...
               END AS bdate,
           CASE
                WHEN NULLIF(LTRIM(RTRIM(gndr)), '') IS NULL THEN 'n/a'
                WHEN REPLACE(REPLACE(UPPER(LTRIM(RTRIM(gndr))), CHAR(13), ''), CHAR(10), '')
